...
function createListItem(listId, number) {
    ...
    let islandIndex = parseInt(number)-1;
    let island_url = '';
    let name = '';
    if(islandIndex < island_urls.length){
        island_url = island_urls[islandIndex];
        name = island_url.split('/')[3];
    }
